...
class LLMClient:
    def __init__(self, kira_config: KiraConfig, provider_mgr: ProviderManager):
        ...
        # Phase 0.1: injected by lifecycle after ModelGroupManager construction.
        # Held here so plugins reaching for ctx.llm_api can also reach the group
        # layer without a separate context field. None during early init only.
